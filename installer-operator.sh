...
$operator ALL=(root) NOPASSWD: /usr/local/bin/diskqual _reset-root --yes
...
EOF
    ...
    ok "UI inventory, SMART observation, phased testing, metadata wipe, qualification reset, and locate privileges configured for $operator"
}
